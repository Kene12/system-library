<?php
    ...
    $objRead = new Read();
    $objPic = new Read();
    $data = $objRead->readreturnn3($getID);
    $id_returnn = $data[0];
    $id_borrow = $data[1];
    $id_book = $data[2];
    $id_rec = $data[3];
...
<div class="topnav" style="height: 50px;">
  <div class="search-container">
    ...
    <form action="updatereturnn.php?id=<?=$id_returnn?>" method="get">
        ...
        <p>ผู้รับ <input type="text" method="get" name="receiver" value="<?=$receiver?>"></p>
